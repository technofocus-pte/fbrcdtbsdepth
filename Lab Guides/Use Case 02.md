...
2.  ![A screenshot of a sign in Description automatically
...
10. Now return to the **tutorial Workspace** in the Fabric portal.
...
class from the GraphQL.Client.Serializer.Newtonsoft library to serialize
the response.
